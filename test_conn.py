...
app.config['MYSQL_USER'] = 'b147132314b5b7'
app.config['MYSQL_PASSWORD'] = '843288d4'
app.config['MYSQL_DB'] = 'heroku_9e24ee40b422be6'
app.config['MYSQL_CURSORCLASS'] = 'DictCursor' #a cursor is a connection to let us run
